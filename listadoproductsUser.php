    ...
    if(isset($_POST["btn-signup"])){
          ...
          else if($id_p<1)
          {
           ...
           ,];
               ...
               $costoPromedio = $funcsql->costoPromedio($id_p);
             }
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="work_Section">
      ...
      <div class="">
        <label for="" > <?php if (is_numeric($costoPromedio)) {echo "Costo Promedio:".$costoPromedio; } else { echo "Costo Promedio 0.00";}  ?></label>
      </div>
